                      ...
                      .setDescription(
                        `> ***START EDITING THE GENERAL MODULE BY SELECTING SOMETHING BELOW*** ${
                          ...
                          interaction.guild?.roles
                            .cache
                            .get(savedGuild.general.holdRoleId as string) 
                            || "None"
                        }\` Hold Role`
                      )
                      ...
                      new StringSelectMenuBuilder()
                        ...
                        .addOptions([
                          new StringSelectMenuOptionBuilder()
                            ...
                            .setDescription("Toggle General module on or off accordinly to your selection.")
                            .setEmoji(
                              savedGuild.general.enabled
                                ? config.emojis.id.on
                          ...
                          new StringSelectMenuOptionBuilder()
                            ...
                            .setEmoji(
                              config.emojis.id.vip
                            ),
                          new StringSelectMenuOptionBuilder()
                            .setLabel("Hold Role")
                            .setValue("holdRole")
                            .setEmoji(
                              config.emojis.id.spark
                            ),
                        ])
                    ),
