...
export default new (class NewsCommand implements SlashCommand {
    data = new SlashCommandBuilder()
      ...
      .addChannelOption(
        (option: SlashCommandChannelOption) => option
                .setName('channel')
    ...
    invoke = async (client: Client, interaction: ChatInputCommandInteraction) => {
        ...
        const news = client.channels.cache.get("1040173761451786271") as NewsChannel;
        ...
        try {
            ...
            await interaction.followUp("An error occurred while following the channel.");
        }
    };
  })();
