    ...
    this.invoke = (message) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          if (
            message.author.bot ||
            !(message === null || message === void 0 ? void 0 : message.guild)
          )
            return;
          const savedGuild =
            (yield GuildSetting_1.GuildSettings.findOne({
              _id: message.guild.id,
            })) || new GuildSetting_1.GuildSettings({ _id: message.guild.id });
          const isCommand = () =>
          ...
          if (isCommand()) {
            ...
            Log_1.default.command(command, message.author);
          } else {
            yield this.messageFiltering.init(message);
          }
        } catch (err) {
